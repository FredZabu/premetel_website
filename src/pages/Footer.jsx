    ...
    return (
      ...
      <div className="flex flex-col  sm:flex-row w-[90%] mx-auto">
          <div className="flex-[1.5]">
              <img src={logo} alt="" />
              <p className="mt-4 sm:w-[90%] w-full  font-title font-medium leading-[30px] tracking-[0.2px] text-light-gray-1 ">Primetel believes in challenging the conventional healthcare systems with the ever-expanding technological advancements in providing efficient,customized, and convenient healthcare services to people in rural areas.</p>
          ...
          <div className="flex-[1] sm:mt-0 mt-10" >
              ...
              <div className="flex items-center mt-4">
                  <BsTelephoneFill color="#FFFFFF" size={30} />
          ...
          <div className="flex-[1] mt-10 sm:mt-0">
            ...
            <div className="w-full flex items-center">
                ...
                <p className="text-main-color text-center mt-2">Terms of Use | Privacy Policy | Terms for Health Providers</p>

                 <p className=" font-title font-medium leading-[30px] tracking-[0.2px] text-main-color"> <span>&#169;</span> All rights reserved to Primetel 2023</p>
                </div>

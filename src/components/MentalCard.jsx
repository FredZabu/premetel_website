    ...
    <div className=" w-[90%] h-[100%] mx-auto ">
        <div className="w-[70%] mx-auto ">
              <div className="w-[90%] mx-auto ">
                  <h1 className="text-[35px]  font-title font-normal sm:leading-[45px] tracking-[0.2px]  mt-5 text-center   text-text-color2 ">Mental Health</h1> 
        ...
        <div>
          <div className="grid place-items-center card">
            ...
            <p className="mt-3 font-para font-medium text-base tracking-[0.2px] text-p-text uppercase">Anxiety</p>            
          </div>
          <div className="grid place-items-center mt-5 card">
            <MdOutlineSick color="#e47521" size={40} />
            <p className="mt-3 font-para font-medium text-base tracking-[0.2px] text-p-text uppercase">Depression</p>              
          </div>
          <div className="grid place-items-center mt-5 card">
            <IoMan color="#e47521" size={40} />
            <p className="mt-3 font-para font-medium text-base tracking-[0.2px] text-p-text uppercase">Postpartum</p>             
          </div>              
        </div>
        ...
        <div>
          <div className="grid place-items-center card">
            ...
            <p className="mt-3 font-para font-medium text-base tracking-[0.2px] text-p-text uppercase">Relationships</p>            
          </div>
          <div className="grid place-items-center mt-5 card">
            <GiMadScientist color="#e47521" size={40} />
            <p className="mt-3 font-para font-medium text-base tracking-[0.2px] text-p-text uppercase">Trauma & Loss</p>              
          </div>
          <div className="grid place-items-center mt-5 card">
            <AiOutlineMedicineBox color="#e47521" size={40} />
            <p className="mt-3 font-para font-medium text-base tracking-[0.2px] text-p-text uppercase">Screenings</p>             
              </div>
        </div> 
        </div>
        </div>

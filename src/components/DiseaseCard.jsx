...
function DiseaseCard() {
  return (
    <div className=" w-[90%] mx-auto ">
        ...
        <div className="w-[90%] mx-auto ">
           <h1 className="text-[35px]  font-title font-normal sm:leading-[45px] tracking-[0.2px]  mt-5 text-center   text-text-color2 ">Urgent Care</h1> 
        ...
        <div>
          <div className="grid place-items-center card">
            ...
            <p className="mt-3 font-para font-medium text-base tracking-[0.2px] text-p-text">ALLERGIES</p>            
          </div>
          <div className="grid place-items-center mt-5 card">
            <FaHeadSideVirus color="#e47521" size={40} />
            <p className="mt-3 font-para font-medium text-base tracking-[0.2px] text-p-text">HEADACHE</p>              
          </div>
          <div className="grid place-items-center mt-5 card">
            <IoMan color="#e47521" size={40} />
            <p className="mt-3 font-para font-medium text-base tracking-[0.2px] text-p-text">MEN'S HEALTH</p>             
          </div>              
        </div>
        ...
        <div>
          <div className="grid place-items-center card">
            ...
            <p className="mt-3 font-para font-medium text-base tracking-[0.2px] text-p-text">SKIN CONDITIONS</p>            
          </div>
          <div className="grid place-items-center mt-5 card">
            <FaPersonPregnant color="#e47521" size={40} />
            <p className="mt-3 font-para font-medium text-base tracking-[0.2px] text-p-text">WOMEN'S HEALTH</p>              
          </div>
          <div className="grid place-items-center mt-5 card">
            <FaDisease color="#e47521" size={40} />
            <p className="mt-3 font-para font-medium text-base tracking-[0.2px] text-p-text">COLD & FLU</p>             
              </div>
        </div> 
        </div>
        </div>

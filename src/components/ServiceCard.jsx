...
function ServiceCard(props) {
  ...
  return (
      <div className={` ${flags=='service'? 'sm:w-[350px] px-6 py-6 lg:px-2 lg:w-[300px] items-center text-center ':'w-auto px-6 py-6 items-start'}  flex  flex-col  h-full   ${id==="keyFocus2" ? 'middleCard bg-[#FFFFFF]' : 'middleCard bg-[#FFFFFF]'} `}  >
          <div className="icon w-[72px]    "><img src={iconImage} alt="" /></div>
          <h1 className={`  font-title font-medium text-xl text-text-color2 tracking-[0.2px]  mt-5`}>{textTitle}</h1>

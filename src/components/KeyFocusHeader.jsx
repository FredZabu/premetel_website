  ...
  return (
      <div className="relative sm:mb-10 ">
          ...
          <div className="flex flex-col sm:flex-row sm:items-center  w-[90%] mx-auto">
              <h1 className="flex-[1] text-xl sm:text-4xl font-title font-normal text-btn-color sm:leading-[67px] tracking-[0.2px] sm:w-[542px] sm:mt-5 mt-5 text-start ">
                  Revolutionizing healthcare<br /><span className="text-text-color">in the following key areas</span>
              </h1>

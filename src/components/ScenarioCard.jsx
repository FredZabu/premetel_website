...
function ScenarioCard(props) {
  ...
  return (
      <div className=  "w-auto px-6 lg:px-2 xl:px-6 py-10  flex  flex-col  h-[320px]  rounded-[50px] border-[1px] border-[#DDDDE8] bg-white"  >
          <div className="icon w-[72px]    "><img src={iconImage} alt="" /></div>
          <h1 className={` font-title font-bold  text-text-color2 text-xl tracking-[0.2px]  mt-2 `}>{textTitle}</h1>

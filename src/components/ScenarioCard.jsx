...
function ScenarioCard(props) {
  ...
  return (
      <div className=  "w-auto px-6 lg:px-2 xl:px-6 py-10  flex  flex-col  h-[300px]  rounded-[50px] border-[1px] border-[#DDDDE8] bg-white"  >
          ...
          <h1 className={` font-title font-normal text-third-dark tracking-[0.2px]  mt-2 `}>{textTitle}</h1>
          <p className="  leading-[30px] tracking-[0.2px] font-para font-normal text-p-text mt-2">{descript}</p>

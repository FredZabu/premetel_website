...
function Header3() {
  ...
  <motion.div animate={{opacity:1}} initial={{opacity:0}} transition={{type:"tween", duration:1 }} exit={{x:-10, opacity:0, transition:{duration:1}}}  className="  sm:h-[100vh]  ">
      ...
      <div className=" header_parent w-[90%] h-full  sm:w-[90%] bg-transparent  relative mx-auto ">
          ...
          <div className="header_text   p-4 flex flex-col items-center  sm:items-start  mt-0  sm:mt-0 sm:w-[70%] sm:absolute sm:left-0 sm:top-[50%] sm:translate-y-[-50%] ">
        ...
        <motion.div animate={{opacity:1}} initial={{opacity:0}} transition={{type:"tween", duration:1 }} className="header_image hidden w-[30%] right-0 absolute top-0 bottom-0  sm:flex sm:justify-end">

...
function Header2() {
  return (
    <div className="header_parent sm:my-[4rem] w-[90%] sm:w-[90%] mx-[auto] flex items-center justify-between flex-col sm:flex-row ">
 ...
 <div className="banner-btn px-0 mt-0 sm:mt-5 flex justify-between items-center ">
        ...
        <div className="header_image hidden sm:block mt-4 sm:mt-0  w-full flex-[1]  h-full ">

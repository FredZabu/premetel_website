...
function KeyFocusCard(props) {
  ...
  return (
        <div className=" py-5 px-2 sm:w-[380px]  lg:w-[350px]  h-[380px] bg-[#FFFFFF] middleCard">
          ...
          <div className="grid place-items-center">
              <button className= {` mt-10   bg-btn-color text-white  font-para font-bold hover:bg-hover-color hover:text-white  text-[18px] tracking-[0.2px] leading-[22px] py-[14px] px-[18px] rounded-[5px] `}> <Link to="/services" className="flex items-center gap-4"><span>Learn more</span>  <img src={arrow} alt=""  /> </Link> </button>
          </div>
        </div>
  )
}
